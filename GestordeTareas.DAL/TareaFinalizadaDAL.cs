...
//        public static async Task<List<TareaFinalizada>> GetFinalizadasAsync()
//        {
//            using (var dbContext = new ContextoBD())
//            {
//                return await dbContext.TareaFinalizada
//                    .Where(tf => tf.ElegirTarea.EstadoTarea.Id == 3) // Aquí se filtra por estado final
//                    .Include(tf => tf.Imagenes) 
//                    .Include(tf => tf.ElegirTarea) 
//                    .ToListAsync();
//            }
//        }
//    }
