...
namespace GestordeTareas.DAL
{
    public class EstadoTareaDAL
    {
        ...
        public static async Task<int> CreateAsync(EstadoTarea estadoTarea)
        {
            ...
            await dbContext.EstadoTarea.AddAsync(estadoTarea);
        ...
        public static async Task<int> UpdateAsync(EstadoTarea estadoTarea)
        {
            ...
            dbContext.EstadoTarea.Update(estadoTareaDB);
            return await dbContext.SaveChangesAsync();
        }
        ...
        {
            using var dbContext = new ContextoBD();
            return await dbContext.EstadoTarea.FirstOrDefaultAsync(e => e.Id == estadoTarea.Id);
        }
        ...
        {
            using var dbContext = new ContextoBD();
            return await dbContext.EstadoTarea.ToListAsync();
        }
